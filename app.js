...
const currentSiteRepo = document.getElementById("currentSiteRepo")
const currentPageName = document.getElementById("currentPageName")
const siteInfoStatus = document.getElementById("siteInfoStatus")
...
function updateCurrentSiteInfo() {
  ...
  if (currentSiteUrl) currentSiteUrl.textContent = info.siteUrl
  if (currentSiteRepo) currentSiteRepo.textContent = info.repository
  if (currentPageName) currentPageName.textContent = info.pageName
  if (siteInfoStatus) siteInfoStatus.textContent = "AUTO"
  return info
}
