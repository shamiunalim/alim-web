...
if (bgMusic && musicToggle) {
  ...
  function setMusicButton() {
    if (bgMusic.paused) {
      musicToggle.textContent = "🔇 Aktifkan Musik"
    } else {
      musicToggle.textContent = "🔊 Musik Aktif"
    }
  }
  ...
  bgMusic.addEventListener("play", setMusicButton)
  bgMusic.addEventListener("pause", setMusicButton)
  bgMusic.addEventListener("ended", setMusicButton)

  bgMusic.addEventListener("error", () => {
    musicToggle.textContent = "❌ Musik Error"
    console.error("Gagal memuat music.mp3")
  })
