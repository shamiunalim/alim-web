...
function updateAppIdentityUI() {
  ...
  // Manifest statis dipertahankan agar Chrome tetap mengenali PWA dan menyediakan instalasi.
}
...
function updateWebIdentityManifestAndUI(name, icon) {
  ...
  // Nama/ikon website diperbarui di UI; metadata launcher PWA mengikuti manifest yang dipublikasikan.
}
